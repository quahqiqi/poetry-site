...
<head>
  ...
  <style>
    ...
    * {{ box-sizing: border-box; }}
    ...
    .search-panel {{ position: absolute; top: 64px; right: 16px; width: 260px; background: var(--card); border: 1px solid var(--border); border-radius: 12px; padding: 8px; display: none; box-shadow: 0 10px 20px rgba(0,0,0,0.1); }}
...
<body>
  ...
  <header>
    ...
    <div class="search-panel" id="searchPanel">
        <input id="searchInput" type="text" placeholder="回车搜索首页诗作..." />
    </div>
  </header>
